...
import AdminSalesReport from "@/pages/admin-sales-report";
  ...
  return (
    <AuthenticatedLayout>
      <Switch>
        ...
        <Route path="/store-map" component={StoreMapPage} />
        ...
        <Route path="/admin/sales-report">{() => <AdminRoute component={AdminSalesReport} />}</Route>
